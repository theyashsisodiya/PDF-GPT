...
4. Set up your Google API key:
   ...
   Create a `.env` file in the PDF-GPT folder or in your project folder and add your Google API key from (https://aistudio.google.com/app/apikey)[Create API key]:
